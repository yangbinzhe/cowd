...
def main() -> int:
    ...
    manifest = load_manifest(repo_root / "scripts/parity/mock-parity-scenarios.json")
    parity_text = load_parity_text(repo_root / "scripts/parity/PARITY.md")
    ...
    print(f"Scenario manifest: {repo_root / 'scripts/parity/mock-parity-scenarios.json'}")
    print(f"PARITY source: {repo_root / 'scripts/parity/PARITY.md'}")
    print()
