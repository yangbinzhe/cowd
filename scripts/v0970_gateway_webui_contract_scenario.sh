...
PORT="${COWD_V0970_PORT:-18690}"
BASE_URL="http://127.0.0.1:$PORT"
SESSION="cowd-v0970-gateway-$$"
TMP_DIR="$(mktemp -d /tmp/cowd-v0970-gateway.XXXXXX)"
...
if ! command -v tmux >/dev/null 2>&1; then
  echo "tmux is required for v0.9.70 gateway scenario" >&2
  exit 1
fi
