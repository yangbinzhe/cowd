# Agent-first PG-only framework v0.9.724

Cowd v0.9.724 keeps PostgreSQL as the sole production durable-store topology.
...
`docs/evidence/agent-first-model-framework-v0.9.724.md`.
