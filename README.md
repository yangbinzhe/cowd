...
v0.8.21 的核心目标是在 v0.8.20 Runtime Control Plane 之上建立统一 Runtime Event Spine 与 Agent Value Loop：Task、Agent、Context、Memory 和 UI 通过同一事件脊柱解释运行时决策，并用可衡量正收益控制多 Agent 协作。
