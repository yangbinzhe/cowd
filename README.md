...
v0.8.20 的核心目标是在 v0.8.19 Runtime Control Policy 之上建立主动运行时控制面与场景内核：配置、场景 Profile、任务、Agent、Context、Memory 和 UI 由同一套 effective policy 驱动。
