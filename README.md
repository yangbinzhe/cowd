...
内置模型容量为官方口径（2026-08 校准，未配置时按此解析；可用 `model_context_windows` 覆盖）：

| 模型 | 上下文窗口 | 最大输出 | 依据 |
|---|---|---|---|
| deepseek-v4-pro / deepseek-v4-flash | 1M | 384K | DeepSeek API Docs |
| qwen3.8-max / qwen3.7-max / qwen3.7-plus | 1M | 128K | 阿里云百炼文档 |
| qwen3.6-plus / qwen3.6-flash | 1M | 64K | 阿里云百炼文档 |
| qwen3-max | 256K | 64K | 阿里云百炼/百炼控制台 |
| qwen-long | 10M | 8K | 阿里云百炼文档 |
| glm-5.2 | 1M（1,048,576） | 128K | 智谱/阿里云百炼文档 |
| glm-5 | 200K（204,800） | 128K | 智谱/阿里云百炼文档 |
未知模型按 128K 上下文、64K 输出保守估算，仅作兜底。
