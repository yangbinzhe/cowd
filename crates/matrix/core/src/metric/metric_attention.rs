...
pub struct MatrixMetricAttentionPlan {
    ...
    pub limit: usize,
    #[serde(default)]
    pub scored_metrics: Vec<MatrixMetricAttentionScore>,
    #[serde(default)]
...
pub struct MatrixMetricSnapshot {
    ...
    #[serde(default)]
    pub items: Vec<MatrixMetricSnapshotItem>,
    pub created_at: DateTime<Utc>,
    pub summary: String,
}

impl MatrixMetricAttentionScore {
    #[must_use]
    pub fn new(
...
pub fn build_metric_compute_jobs(
    ...
    metric_ids
        ...
        .map(|metric_id| MatrixComputeJobInput {
            ...
            trigger_fact_refs: vec![format!("matrix:metric:{metric_id}")],
