...
pub struct IaccSourcePack {
    ...
    #[serde(default)]
    pub entity_mappings: Vec<IaccSourceEntityMapping>,
    #[serde(default)]
    pub fact_mappings: Vec<IaccSourceFactMapping>,
    #[serde(default)]
...
pub struct IaccSourceEntityMapping {
    pub source_entity: String,
    pub iacc_entity_type: String,
    pub source_key_field: String,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IaccSourceFactMapping {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IaccSourcePackValidation {
    pub source_pack_id: String,
    pub status: String,
    #[serde(default)]
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IaccSourceDeltaPlan {
    pub source_pack_id: String,
    #[serde(default)]
...
impl IaccSourcePack {
    ...
    #[must_use]
    pub fn validate(&self) -> IaccSourcePackValidation {
