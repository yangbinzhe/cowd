...
pub struct IaccDomainPack {
    ...
    #[serde(default)]
    pub scenarios: Vec<IaccDomainScenario>,
}

#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccDomainSeedPlan {
    pub pack: IaccDomainPack,
    #[serde(default)]
    pub entities: Vec<IaccEntity>,
    #[serde(default)]
    pub relations: Vec<IaccRelation>,
    #[serde(default)]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccDomainSeedResult {
    pub domain_id: String,
    pub version: String,
...
#[must_use]
pub fn server_manufacturing_domain_pack() -> IaccDomainPack {
...
#[must_use]
pub fn server_manufacturing_seed_plan() -> IaccDomainSeedPlan {
...
fn server_manufacturing_scenarios() -> Vec<IaccDomainScenario> {
    vec![
        IaccDomainScenario {
...
fn server_manufacturing_entities() -> Vec<IaccEntity> {
    vec![
        entity(
...
fn server_manufacturing_relations() -> Vec<IaccRelation> {
    vec![
        relation(
            "requires",
            "entity-product-ai-server-8gpu",
...
fn server_manufacturing_metric_definitions() -> Vec<IaccMetricDefinition> {
    vec![
        metric(
            "material_shortage_risk",
...
fn server_manufacturing_facts() -> Vec<IaccFact> {
    vec![
        fact(
            ...
            vec![
                "component:gpu-h100",
                "iacc:entity:entity-component-gpu-h100",
            ],
            "material_shortage_risk",
        ...
        fact(
            ...
            vec![
                ...
                "iacc:entity:entity-supplier-gpu-alpha",
            ],
            "supplier_commit_variance",
        ...
        fact(
            ...
            vec![
                ...
                "iacc:entity:entity-work-center-final-assembly",
            ],
            "work_center_load",
        ...
        fact(
            ...
            vec![
                ...
                "iacc:entity:entity-order-co-2026-0001",
            ],
            "order_delivery_risk",
        ...
        fact(
            ...
            vec![
                ...
                "iacc:entity:entity-component-dimm-64g",
            ],
            "quality_escape_risk",
...
fn entity(
    ...
    IaccEntity::from_input(IaccEntityInput {
...
fn relation(
    ...
    IaccRelation::from_input(IaccRelationInput {
...
fn metric(
    ...
    IaccMetricDefinition {
        ...
        formula_ref: format!("iacc://domain/server_manufacturing/metrics/{metric_id}/v0.9.85"),
...
fn fact(
    ...
    IaccFact::from_input(IaccFactInput {
...
fn source_key(source_system: &str, source_key: &str, source_ref: &str) -> IaccSourceKey {
    IaccSourceKey {
