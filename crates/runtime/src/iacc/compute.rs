...
pub struct IaccComputeJobInput {
    #[serde(default)]
...
impl IaccComputeJob {
    #[must_use]
    pub fn from_input(input: IaccComputeJobInput) -> Self {
        let now = Utc::now();
        Self {
            job_id: input
                .job_id
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccComputePlan {
    pub job: IaccComputeJob,
    #[serde(default)]
