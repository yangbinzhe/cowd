...
pub struct IaccMetricDependencyInput {
    #[serde(default)]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccMetricDependency {
...
impl IaccMetricDependency {
    #[must_use]
    pub fn from_input(input: IaccMetricDependencyInput) -> Self {
        let now = Utc::now();
        Self {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccMetricLineage {
    pub metric_id: String,
    #[serde(default)]
    pub upstream_dependencies: Vec<IaccMetricDependency>,
    #[serde(default)]
    pub downstream_dependencies: Vec<IaccMetricDependency>,
    #[serde(default)]
