...
use super::{IaccActionExecution, IaccEvidencePacket, IaccIncident, IaccOperationalAnalysis};

#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccMemoryCase {
    pub case_id: String,
...
pub struct IaccPlaybook {
    ...
    pub metric_keys: Vec<String>,
    #[serde(default)]
    pub recommended_steps: Vec<IaccPlaybookStep>,
    #[serde(default)]
    pub required_evidence: Vec<String>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccCasePromotion {
    pub memory_case: IaccMemoryCase,
    pub playbook: IaccPlaybook,
}
...
impl IaccMemoryCase {
    ...
    pub fn from_closed_loop(
        ...
        executions: &[IaccActionExecution],
    ) -> Self {
        let now = Utc::now();
...
fn domain_for_case(case: &IaccMemoryCase) -> String {
    if case
        .metric_keys
        .iter()
...
fn scenario_for_case(case: &IaccMemoryCase) -> String {
    if case
        .metric_keys
        .iter()
