...
use super::{IaccOperationalAnalysis, IaccRecommendedAction};

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IaccActionExecutionRequest {
...
pub struct IaccActionExecution {
...
impl IaccActionExecution {
    #[must_use]
    pub fn from_action(
        analysis: &IaccOperationalAnalysis,
        action: &IaccRecommendedAction,
        ...
        Self {
            ...
            receipt: serde_json::json!({
                "receipt_kind": "iacc.action.execution",
...
fn merge_feedback_receipt(receipt: &Value, feedback: &IaccActionFeedback, status: &str) -> Value {
