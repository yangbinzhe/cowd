...
pub struct IaccAttributionCandidate {
    pub cause_id: String,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccRecommendedAction {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct IaccOperationalAnalysis {
    pub analysis_id: String,
    pub incident_id: String,
    pub evidence_packet_id: String,
    #[serde(default)]
    pub attribution_candidates: Vec<IaccAttributionCandidate>,
    #[serde(default)]
    pub impact_paths: Vec<IaccImpactPath>,
    #[serde(default)]
    pub recommended_actions: Vec<IaccRecommendedAction>,
    pub confidence: f32,
    pub status: String,
    pub created_at: DateTime<Utc>,
}

impl IaccOperationalAnalysis {
    #[must_use]
    pub fn from_evidence(incident_id: impl Into<String>, packet: &IaccEvidencePacket) -> Self {
        ...
        for change in &packet.change_evidence {
            ...
            analysis.impact_paths.push(IaccImpactPath {
...
fn recommended_action(
    ...
    if metric.contains("shortage") {
        return IaccRecommendedAction {
            ...
            command_hint: Some("iacc://actions/supply/recovery-review".to_string()),
    ...
    IaccRecommendedAction {
        ...
        expected_effect: "Convert detected metric risk into a governed operating response"
            .to_string(),
        required_evidence: evidence_refs.to_vec(),
        command_hint: Some("iacc://actions/operations/evidence-review".to_string()),
        governance: "human_review_required".to_string(),
    }
}
