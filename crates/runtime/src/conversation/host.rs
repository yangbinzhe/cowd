...
fn successful_runtime_focus_scope_keys(
    calls: &[ModelToolCall],
    successful_call_ids: &BTreeSet<String>,
    required_scopes: &[String],
) -> BTreeSet<String> {
