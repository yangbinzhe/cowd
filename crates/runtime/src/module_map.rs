...
pub fn runtime_module_map() -> Vec<RuntimeModuleDescriptor> {
    ...
    vec![
        ...
        RuntimeModuleDescriptor::public("team_builder", Team, "runtime", true),
        ...
        RuntimeModuleDescriptor::public("team_lift_gate", Team, "runtime", false),
        ...
        RuntimeModuleDescriptor::public("team_template_registry", Team, "runtime", false),
