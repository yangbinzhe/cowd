...
use crate::app::{SessionSummary, TimelineEntry};
use crate::components::base::{Component, EventResult, RenderContext};
use crate::components::dialog::{DialogKind, DialogManager, DialogResult, DialogState};
...
mod tests {
    ...
    use crate::components::dialog::{DialogKind, DialogManager};
