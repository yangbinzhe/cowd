...
use crate::persistence::sqlite::{
    ...
    SessionMessageMetadata, SessionPresenceProjection, SessionRecord, SessionRecoveryManifest,
...
macro_rules! session_store_backend_contract {
    ($macro:ident) => {
        $macro! {
            ...
            (attach_session_runtime_outbox, (input_id: &str, session_generation: u64, expected_revision: u64, target_turn_id: &str, actor: &str, reason: &str, now_ms: u64), Result<SessionRuntimeOutboxRecord>),
            ...
            (session_runtime_outbox_for_turn_relation, (session_id: &str, session_generation: u64, turn_id: &str), Result<Vec<SessionRuntimeOutboxRecord>>),
