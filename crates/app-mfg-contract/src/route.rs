...
mfg_route_contracts! {
    ...
    ReportReviewRequest, "mfg.report.review.request", "POST", "/api/apps/mfg/cockpit/reports/:id/reviews", Contract, Create, MfgCapabilityRequirement::One { capability: C::ReportDeliver }, Medium, Target, true, [Webui, TuiP0], PlannedV541;
    ReportReviewList, "mfg.report.review.list", "GET", "/api/apps/mfg/cockpit/report-reviews", Contract, Read, MfgCapabilityRequirement::One { capability: C::ReportReview }, Low, None, false, [Webui, TuiP0], PlannedV541;
    ReportReviewGet, "mfg.report.review.get", "GET", "/api/apps/mfg/cockpit/report-reviews/:id", Contract, Read, MfgCapabilityRequirement::One { capability: C::ReportReview }, Low, None, false, [Webui, TuiP0], PlannedV541;
    ReportReviewDecide, "mfg.report.review.decide", "POST", "/api/apps/mfg/cockpit/report-reviews/:id/decision", Contract, Effect, MfgCapabilityRequirement::PerAction, High, TargetAndConfirm, true, [Webui, TuiP0], PlannedV541;
