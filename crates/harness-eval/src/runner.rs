...
pub fn run_eval_controlled(
    ...
    let mut scenarios = vec![
        json!({
            ...
            "evidence": format!("{}/{} deterministic contract scenarios passed", stable_ai.fake_provider_result.passed, stable_ai.fake_provider_result.total),
    ...
    let mut runtime_action_log = vec![
        json!({"index": 1, "action": "stable_ai_scenario_matrix", "evidence": "deterministic provider contract suite"}),
