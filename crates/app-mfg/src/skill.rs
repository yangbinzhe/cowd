...
pub struct MfgSkillPlan {
    pub incident_id: String,
    #[serde(default)]
    pub selected_skills: Vec<MfgSkillManifest>,
    #[serde(default)]
...
pub fn run_server_manufacturing_skill(
    ...
    let context = MfgSkillExecutionContext {
        incident_id: incident.incident_id.clone(),
    ...
    let tool_plan = skill
        ...
        .iter()
        .enumerate()
        .map(|(index, tool_name)| MfgSkillToolCall {
...
fn skill(seed: SkillSeed<'_>) -> MfgSkillManifest {
    MfgSkillManifest {
        ...
        required_evidence: seed
            ...
            .collect(),
        tools: vec![
            "mfg.metric_lineage".to_string(),
            "mfg.entity_impact_trace".to_string(),
...
fn score_skill(skill: &MfgSkillManifest, text: &str, metric_keys: &[String]) -> usize {
