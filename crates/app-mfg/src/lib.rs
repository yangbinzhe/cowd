...
pub use skill::{
    ...
    server_manufacturing_skill_pack, skill_agent_node_id, MfgSkillExecutionContext,
    MfgSkillManifest, MfgSkillPlan, MfgSkillRun, MfgSkillTelemetry, MfgSkillToolCall,
    MfgSkillToolResult,
};
