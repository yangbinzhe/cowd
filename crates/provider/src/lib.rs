...
pub use client::{
    ...
    resolve_startup_auth_source, MessageStream, OAuthTokenSet, ProviderClient, ProviderWireHeader,
    ProviderWireRequest,
};
...
pub use types::{
    ...
    ToolChoice, ToolDefinition, ToolResultContentBlock, TransportActivity, Usage,
};
